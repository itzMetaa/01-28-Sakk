...
public class Mezo extends JButton {
    ...
    public void frissit(){
        ...
        switch (this.ertek){
            ...
            case 15: fajlNev = "img/feherKiraly.png"; break;
            case 16: fajlNev = "img/feherVezer.png"; break;
            ...
            case 25: fajlNev = "img/feketeKiraly.png"; break;
            case 26: fajlNev = "img/feketeVezer.png"; break;
        }
